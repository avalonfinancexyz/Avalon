...
export const rateStrategyVolatileBTCOne: IInterestRateStrategyParams = {
  name: "rateStrategyVolatileBTCOne",
  optimalUsageRatio: parseUnits("0.75", 27).toString(),
  baseVariableBorrowRate: parseUnits("0", 27).toString(),
  variableRateSlope1: parseUnits("0.10", 27).toString(),
...
export const rateStrategyVolatileBTCTwo: IInterestRateStrategyParams = {
  name: "rateStrategyVolatileBTCTwo",
  optimalUsageRatio: parseUnits("0.75", 27).toString(),
  baseVariableBorrowRate: parseUnits("0", 27).toString(),
  variableRateSlope1: parseUnits("0.05", 27).toString(),
  variableRateSlope2: parseUnits("0.5", 27).toString(),
...
export const rateStrategyVolatileBTCThree: IInterestRateStrategyParams = {
  name: "rateStrategyVolatileBTCThree",
  optimalUsageRatio: parseUnits("0.75", 27).toString(),
  baseVariableBorrowRate: parseUnits("0", 27).toString(),
  variableRateSlope1: parseUnits("0.03", 27).toString(),
  variableRateSlope2: parseUnits("0.5", 27).toString(),
  stableRateSlope1: parseUnits("0.07", 27).toString(),
  stableRateSlope2: parseUnits("3", 27).toString(),
  baseStableRateOffset: parseUnits("0.02", 27).toString(),
