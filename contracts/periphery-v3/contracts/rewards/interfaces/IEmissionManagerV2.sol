...
import {IRewardsControllerV2} from './IRewardsControllerV2.sol';

/**
 * @title IEmissionManagerV2
 * @author Aave
 * @notice Defines the basic interface for the Emission Manager
 */
interface IEmissionManagerV2 {
  /**
   ...
   */
  function getRewardsController() external view returns (IRewardsControllerV2);
