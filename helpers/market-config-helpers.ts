...
import MerlinInnConfig from "../markets/merlinInn";
...
import {
  ...
  getTestnetRewardAddressFromSymbol,
  POOL_DATA_PROVIDER,
} from ".";
...
import CoredaoConfig from "../markets/coredao";
...
export const loadPoolConfig = (configName: ConfigNames): PoolConfiguration => {
  switch (configName) {
    ...
    case ConfigNames.Merlin:
      return MerlinConfig;
    case ConfigNames.MerlinInn:
      return MerlinInnConfig;
