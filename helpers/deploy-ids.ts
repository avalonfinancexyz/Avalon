...
export const ATOKENV2_IMPL_ID = `ATokenV2-${MARKET_NAME}`;
export const ATOKENV4_IMPL_ID = `ATokenV4-${MARKET_NAME}`;
export const DISABLE_ATOKEN_IMPL_ID = `Disable-AToken-${MARKET_NAME}`;
...
export const DISABLE_STABLE_DEBT_TOKEN_IMPL_ID = `Disable-StableDebtToken-${MARKET_NAME}`;
export const VARIABLE_DEBT_TOKEN_IMPL_ID = `VariableDebtToken-${MARKET_NAME}`;
export const VARIABLE_DEBT_TOKENV2_IMPL_ID = `VariableDebtTokenV2-${MARKET_NAME}`;
...
export const INCENTIVESV2_PROXY_ID = "IncentivesV2Proxy";
export const EMISSION_MANAGER_V2_ID = "EmissionManagerV2";
export const INCENTIVES_V3_IMPL_ID = `IncentivesV3-${IMPL_ID}`;
...
export const INCENTIVES_ES_TOKEN_STRATEGY_ID = `EsTokenTransferStrategy`;
